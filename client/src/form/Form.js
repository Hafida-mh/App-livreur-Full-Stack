                ...
                <form onSubmit={(e) => e.preventDefault()}>
                    <div className='formItem'>
                        <div className='nameForm'>
                            ...
                            <div> <input className='inputFiled' type="text" value={props.name} onChange={
                                props.getName
                            } /></div>
                        </div>
                        ...
                        <div className='nameForm'>
                            ...
                            <div> <input className='inputFiled' type="text" value={props.secondname} onChange={ 
                                props.getsecondName
                            } /></div>
                        </div>
                    </div>
                    ...
                    <div className='formItemInfo'>
                        <div className='nameFormInfo'>
                            ...
                            <div> <input className='inputFiledInfo' value={props.Adress} onChange={
                                props.getAdress
                            } /></div>
                        </div>
                    </div>
                    ...
                    <div className='formItemInfo'>
                        <div className='nameFormInfo'>
                            ...
                            <div> <input className='inputFiledInfo' type="text" onChange={ 
                                props.getPhone
                            
                            } value={props.phone} /></div>
                        </div>
                    </div>
                    ...
                    <div className='formItemInfo'>
                        <div className='nameFormInfo'>
                            ...
                            <div> <input className='inputFiledInfo' type="text" value={props.Email} onChange={ 
                                props.getEmail
                            } /></div>
                        </div>
                    </div>
                    ...
                    <div className='formItem password'>
                        <div className='nameForm'>
                            ...
                            <div> <input className='inputFiled' type="password" value={props.password} onChange={
                                props.getPassword
                            } /></div>
                        </div>
                        ...
                        <div className='nameForm confirmation'>
                            ...
                            <div> <input className='inputFiled' type="password" value={props.confirmedPassword} onChange={ 
                                props.getConfirmedpassword
                            } /></div>
                        </div>
                    </div>
                    ...
                    {props.vehicule && <div className='profilClient'>
                        ...
                        <div className='selectChoice'>
                            <div>  <select id="sectionVehicule" defaultValue={'DEFAULT'}  onChange={props.getvehicule}  className='selectfieldInfo'>
...

                    {
                        props.wilaya && <div className='profilClient'>
                            ...
                            <div className='selectChoice'>
                                <div>  <select id="sectionStatut" defaultValue={'DEFAULT'} onChange={props.getWilaya} className='selectfieldInfo'>
