          ...
          { <div className='sides' data-aos="zoom-in"  data-aos-duration="1500">
              ...
              <div className='buttonsSection'> 
                  <div className='button1'> 
                      <a href="#cli">  
                         <button>  Je cherche un livreur </button> 
                      </a> 
                   </div>
                  <div className='button1'> 
                     <a href="#liv"> 
                        <button > Je suis livreur  </button>  
                     </a>
                  </div>
              </div>
        </div>
      ...
      <div className='workSection'>
        ...
        <div className='workSection1 section2' >
          <div className='cherche' > 
            <div className='checheTitle'> {t("jecherche")} </div>  
            <div className='chercheLivreur'> {t("jechercheunclient")} </div> 
          </div>
          <div className='clientSection'>
            <div className='clientSectionText livr' data-aos="zoom-in"> {t("connexiontextlivreur")}  </div>
            <div className='linkConnexion'> 
              <Link to="/loginLivreur" className='linkToClient'>  > {t("connexiobspacelivreur")} </Link> 
            </div>
